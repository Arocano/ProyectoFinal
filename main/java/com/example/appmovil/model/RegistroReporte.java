...
public class RegistroReporte extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
   ...
   public void getTipoActividad(){
    ...
    public void getActivdad(){
        ...
        actividad.clear();
        actividad.add(new Actividad(1,"PC","PC",1));
        actividad.add(new Actividad(2,"TABLET","TABLET",1));
        actividad.add(new Actividad(3,"Teléfono IP","Teléfono IP",1));
        actividad.add(new Actividad(4,"Servidor BD","Servidor BD",1));
        actividad.add(new Actividad(5,"Servidor correo","Servidor correo",1));
